...
def load_data():
    ...
    overrides = {
        # URN → first prefs + calculated ratio
        100491: {"Apps Received 2025": 169, "Oversub Ratio": 583},  # Oratory Roman Catholic Primary
